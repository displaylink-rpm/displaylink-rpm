...
DisplayLink_Ubuntu_$(VERSION).zip:
	wget -O DisplayLink_Ubuntu_$(VERSION).zip http://downloads.displaylink.com/publicsoftware/DisplayLink_Ubuntu_$(VERSION).zip

rpm: i386/displaylink-$(VERSION)-$(RELEASE).i386.rpm x86_64/displaylink-$(VERSION)-$(RELEASE).x86_64.rpm

i386/displaylink-$(VERSION)-$(RELEASE).i386.rpm: DisplayLink_Ubuntu_$(VERSION).zip displaylink.spec
...
x86_64/displaylink-$(VERSION)-$(RELEASE).x86_64.rpm: DisplayLink_Ubuntu_$(VERSION).zip displaylink.spec
...
displaylink-$(VERSION)-$(RELEASE).src.rpm: DisplayLink_Ubuntu_$(VERSION).zip displaylink.spec
